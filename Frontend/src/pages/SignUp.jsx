...
//       // Use a className for additional styling if needed
...
//     <>
//       <ToastContainer />
//       <div className={`flex form-container items-center justify-center ${loading ? 'filter blur-sm' : ''}`}>
//         <div className='border-2 bg-zinc-700 rounded-md p-5 border-blue-300'>
...
//           {/* Loading Spinner */}
//           {loading && (
//             <div className="loading-container flex justify-center items-center mt-4">
//               <div className="spinner-border animate-spin border-4 border-blue-500 rounded-full w-8 h-8"></div>
//               <p className="ml-3">Sending verification mail. Please wait...</p>
//             </div>
//           )}
...
const SignUp = () => {
  ...
  return (
    <>
      ...
      <div>
      {loading && (
            <div className="loading-container flex justify-center items-center mt-10 relative inset-0 z-50 bg-white bg-opacity-50 ">
