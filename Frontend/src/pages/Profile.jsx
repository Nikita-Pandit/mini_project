...
//       console.log(fetchedProfile.image);
//       setProfile((prevProfile) => ({
//         ...prevProfile,
//         ...fetchedProfile,
//       }))

//       // setImage(`http://localhost:20000/uploads/${fetchedProfile.image}`);
//       setImage(fetchedProfile.image ? `http://localhost:20000/uploads/${fetchedProfile.image}` : assets.upload_area);
//     } catch (error) {
//       console.error("Error in fetching profile info:", error);
//     }
//   };
...
// })
//   // Check if the image is a File object before appending it
...
//     src={
//       typeof image === "string"
//         ? `http://localhost:20000/uploads/${image}` // Use the image URL from the server
...
//     image
//       ? typeof image === "string"
//         ? `http://localhost:20000/uploads/${image}`
//         : URL.createObjectURL(image)
//       : assets.upload_area // Replace with the actual path to your default image
//   }
//   alt="Uploaded Profile"
// /> */}
// <img
//   src={image || assets.upload_area} // Display the image or the default fallback
//   alt="Uploaded Profile"
// />
